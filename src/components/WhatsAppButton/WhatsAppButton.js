  ...
  return (
    <div className={styles.floatingButtons}>
      <a 
        ...
        className={`${styles.floatingButton} ${styles.callButton} ${isMounted ? styles.client : ''}`}
        aria-label="Call us"
      >
      ...
      <a
        ...
        className={`${styles.floatingButton} ${styles.whatsappButton} ${isMounted ? styles.client : ''}`}
        target="_blank"
