  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Simple gold-bordered buttons with pure CSS" />
      </Head>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h2 style={{ color: 'white', marginBottom: '20px' }}>Simple Gold Buttons</h2>
          
          <div style={{ marginBottom: '20px' }}>
            <h3 style={{ color: 'white', marginBottom: '15px' }}>Basic Button:</h3>
            <SimpleGoldButton 
              text="زر ذهبي بسيط" 
          ...
          <div style={{ marginBottom: '20px' }}>
            <h3 style={{ color: 'white', marginBottom: '15px' }}>Homepage Style Button:</h3>
            <SimpleGoldButton 
              text="اكتشف المزيد" 
              href="/destinations"
            />
          ...
          <div style={{ 
            ...
            <h3 style={{ color: '#ffd700', marginBottom: '15px' }}>ميزات هذا النوع من الأزرار</h3>
          ...
          <div style={{ marginTop: '40px' }}>
            <h3 style={{ color: 'white', marginBottom: '15px' }}>المقارنة مع الأزرار الأخرى:</h3>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', justifyContent: 'center', marginTop: '20px' }}>
              <SimpleGoldButton text="الأزرار ذات الخلفية السوداء" href="/pure-black-gold-buttons" />
              <SimpleGoldButton text="الأزرار المحسنة" href="/optimized-gold-buttons" />
              <SimpleGoldButton text="الرجوع للرئيسية" href="/" icon={<ArrowIcon />} />
            </div>
          </div>
        </div>
      </div>
