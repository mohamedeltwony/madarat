...
export default function AzerbaijanTrip() {
  ...
  return (
    <div className={styles.container} dir="rtl">
      <Head>
        <title>استكشف اذربيجان مع مدارات الكون | رحلة ساحرة - السعر لا يشمل الطيران</title>
        <meta
          name="description"
          content="رحلة سياحية استثنائية إلى اذربيجان مع شركة مدارات الكون للسياحة والسفر. اكتشف جمال الطبيعة والتاريخ والثقافة في اذربيجان. السعر 1990 ريال لا يشمل تذاكر الطيران."
        />
        <meta
          name="viewport"
