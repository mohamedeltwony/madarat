...
export default function LondonScotlandTripB() {
  // Renamed function
  ...
  return (
    <div className={styles.container} dir="rtl">
      <Head>
        <title>استكشف لندن واسكتلندا مع مدارات الكون | رحلة ساحرة - B</title>{' '}
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.title}>
              ...
              <span className={styles.highlight}>اسكتلندا</span> الساحرة (B){' '}
              {/* Added variant indicator */}
            </h1>
