      ...
      <div className="rtl">
        ...
        <div className={styles.heroSection}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>نوفر لك تجربة سفر استثنائية مع أفضل الخدمات والأسعار المناسبة</p>
          </div>
        </div>
              ...
              {formSubmitted ? (
                <div className={styles.successMessage}>
                  ...
                  <p className={styles.successText}>
                    شكراً لك! سيقوم فريقنا بالتواصل معك في أقرب وقت ممكن لتأكيد حجزك وتقديم كافة التفاصيل اللازمة.
                  </p>
                  <button 
                ...
                <div className={styles.formCard}>
                  <div className={styles.formInfo}>
                    ...
                    <p className={styles.formDescription}>
                      املأ النموذج أدناه وسيتواصل معك أحد مستشاري السفر خلال 24 ساعة لترتيب رحلتك المثالية
                    </p>
                  </div>
                  ...
                  <form className={styles.bookingForm} onSubmit={handleSubmit}>
                    <div className={`${styles.formGroup} ${styles.floatingLabelGroup} ${styles.phoneGroup}`}>
                    ...
                    <div className={`${styles.formGroup} ${styles.floatingLabelGroup}`}>
                      <select 
                        ...
                        onChange={handleChange}
                      >
                        <option value="— الرجاء تحديد اختيار —">— الرجاء تحديد اختيار —</option>
                      ...
                      <label htmlFor="destination" className={styles.formLabel}>الوجهة</label>
                    </div>
                    ...
                    >
                      {isSubmitting ? 'جاري الإرسال...' : 'اضغط هنا وارسل بياناتك وبيتواصل معاك واحد من متخصصين السياحة لدينا'}
                    </button>
                  </form>

                  <div className={styles.featuresSection}>
                    <h3 className={styles.featuresTitle}>لماذا تختار السفر معنا؟</h3>
                    <div className={styles.featuresGrid}>
                      <div className={styles.featureItem}>
                        ...
                        <div className={styles.featureContent}>
                          <h4 className={styles.featureTitle}>حجز آمن ومضمون</h4>
                          <p className={styles.featureDescription}>ضمان استرداد كامل المبلغ في حالة عدم الحصول على التأشيرة</p>
                        </div>
                      </div>
                      ...
                      <div className={styles.featureItem}>
                        ...
                        <div className={styles.featureContent}>
                          <h4 className={styles.featureTitle}>خدمة عملاء متميزة</h4>
                          <p className={styles.featureDescription}>دعم على مدار الساعة أثناء رحلتك من فريق متخصص يتحدث العربية</p>
                        </div>
                      </div>
                      ...
                      <div className={styles.featureItem}>
                        ...
                        <div className={styles.featureContent}>
                          <h4 className={styles.featureTitle}>فنادق في أفضل المواقع</h4>
                          <p className={styles.featureDescription}>نختار فنادقنا بعناية في مواقع مميزة قريبة من المعالم السياحية</p>
                        </div>
                      </div>
                      ...
                      <div className={styles.featureItem}>
                        ...
                        <div className={styles.featureContent}>
                          <h4 className={styles.featureTitle}>برامج سياحية متكاملة</h4>
                          <p className={styles.featureDescription}>خطط سفر مدروسة تشمل أفضل المعالم والمزارات السياحية في كل وجهة</p>
                        </div>
                      </div>
                    </div>
                  </div>
