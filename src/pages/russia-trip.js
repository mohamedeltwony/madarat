...
export default function RussiaTrip() {
  ...
  const [formData, setFormData] = useState({
    ...
    destination: 'روسيا', // Changed destination
  });
      ...
      const response = await fetch('/api/fb-events', {
        ...
        body: JSON.stringify({
          ...
          custom_data: {
            ...
            destination: data.destination, // This will be 'روسيا' from state
            full_name: data.name,
          },
    ...
    try {
      ...
      try {
        ...
        const zapierPayload = {
          ...
          destination: 'روسيا',
          formSource: 'russia-trip',
          formName: 'Russia Trip Form',
