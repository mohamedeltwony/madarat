...
export default function TrabzonNorthTurkeyTrip() {
  ...
  return (
    <div className={styles.container} dir="rtl">
      <Head>
        <title>استكشف الشمال التركي مع مدارات الكون | طربزون وايدر - السعر لا يشمل الطيران</title>
        <meta
          name="description"
          content="رحلة فاخرة الى الشمال التركي مع شركة مدارات الكون للسياحة والسفر. استمتع بإقامة فاخرة في أكواخ طبيعية خلابة وتجربة سياحية مميزة في طربزون وايدر. السعر 2699 ريال لا يشمل تذاكر الطيران."
        />
        <meta
          name="viewport"
