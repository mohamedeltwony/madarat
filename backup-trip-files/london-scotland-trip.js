...
export default function LondonScotlandTrip() {
  ...
  // Get trip configuration inside component to avoid Fast Refresh issues
  const tripConfig = getTripConfig('london-scotland-trip');
  const snapchatTripData = getSnapchatTripData('london-scotland-trip');
  ...
  const handleFormSuccess = ({ processedPhone, externalId, leadEventId, nationality, email, name, firstName, lastName }) => {
    ...
    queryParams.set('trip_source', 'london-scotland-trip');
