...
function App({
  ...
  useEffect(() => {
    const handleRouteChange = (url) => {
      ...
      // Store timer ID to clear if needed during cleanup (though less likely needed here)
      (router as any).routeChangeTimerId = routeChangeTimer;
    };
    ...
    return () => {
      ...
      if ((router as any).routeChangeTimerId) {
        clearTimeout((router as any).routeChangeTimerId);
      }
    };
