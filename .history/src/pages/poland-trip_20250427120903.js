...
export default function PolandTrip() {
  ...
  const [formData, setFormData] = useState({
    ...
    destination: 'بولندا', // Changed destination
  });
      ...
      const response = await fetch('/api/fb-events', {
        ...
        body: JSON.stringify({
          ...
          custom_data: {
            ...
            destination: data.destination, // This will be 'بولندا' from state
            full_name: data.name,
          },
  ...
  // Features data - Updated for Poland
  const features = [
    { text: 'إقامة الفندقية مع الإفطار' }, // Note: Icons removed as none were provided for Poland
    { text: 'إستئجار السيارة مع التأمين الأساسي' },
    { text: 'الرخصة الدولية' },
    { text: 'دليل سياحي كامل' },
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.description}>
              ...
              <br />
              <br />
              - إقامة الفندقية مع الإفطار
              <br />
              - إستئجار السيارة مع التأمين الأساسي
              <br />
              - الرخصة الدولية
              <br />
              - دليل سياحي كامل
            ...
            <div className={styles.featuresSection}>
              <div className={styles.featuresGrid}>
                ...
                {[...features, ...features].map((feature, index) => (
                  <div
                    key={`${feature.text}-${index}`} // Use text for key, added index for uniqueness
                    className={styles.featureItem}
                  >
                    {/* Icons removed as none were provided for Poland */}
