...
import VisaIcon from '@/Icons/تأشيرة.svg';
import ComfortIcon from '@/Icons/راحة.svg';
import FlexibleIcon from '@/Icons/مواعيد مرنه.svg';
import LuxuryIcon from '@/Icons/اقامة فاخرة.svg'; // Assuming this is the correct filename
import EventsIcon from '@/Icons/فاعليات.svg';
import RiverIcon from '@/Icons/اطلالة.svg';
import PriceIcon from '@/Icons/اسعار تنافسيه.svg';
import RatingIcon from '@/Icons/تقييمات.svg';
import GuideIcon from '@/Icons/مرشد.svg';
import CustomIcon from '@/Icons/جولات.svg';
...
export default function LondonScotlandTrip() {
  ...
  // Features data - Reverted to use icon keys
  const features = [
  ...
  // Map icon keys to imported components
            ...
            <div className={styles.featuresSection}>
              <div className={styles.featuresGrid}>
                ...
                {[...features, ...features].map((feature, index) => (
                  <div
                    key={`${feature.icon}-${index}`} // Use icon key again
                    className={styles.featureItem}
                  >
                    {' '}
                    {/* Added index to key for uniqueness */}
                    <div className={styles.featureIcon}>
                      {/* Render the correct icon component based on the map */}
                      {React.createElement(iconComponents[feature.icon] || 'div', {
