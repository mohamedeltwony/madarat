...
export default function LondonScotlandTripB() { // Renamed function
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    city: '',
    destination: 'لندن واسكتلندا - B' // Added variant indicator
  });
  ...
  const handleSubmit = (e) => {
    ...
    alert('شكراً لك! سنتواصل معك قريباً. (Variant B)'); // Added variant indicator
  ...
  return (
    <div className={styles.container} dir="rtl">
      <Head>
        <title>استكشف لندن واسكتلندا مع مدارات الكون | رحلة ساحرة - B</title> {/* Added variant indicator */}
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.title}>
              رحلة <span className={styles.highlight}>لندن</span> و <span className={styles.highlight}>اسكتلندا</span> الساحرة (B) {/* Added variant indicator */}
            </h1>
