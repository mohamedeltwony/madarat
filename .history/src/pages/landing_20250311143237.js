      ...
      <main className={styles.main}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <div className={styles.buttonContainer}>
              <SparkleButton onClick={handleShowForm}>اشترك الآن</SparkleButton>
            </div>
          </div>
        </section>
        ...
        <section className={styles.bentoSection}>
          ...
          <div className={UIStyles.bentoGrid}>
            ...
            <div
              className={`${UIStyles.glassCard} ${UIStyles.bentoItem} ${UIStyles.large}`}
            >
              <div className={styles.bentoContent}>
                ...
                <p>
                  أكثر من 1000 مقال ومحتوى متميز في مختلف المجالات الإبداعية
                  والفكرية وتطوير الذات
                </p>
            ...
            <div className={`${UIStyles.glassCard} ${UIStyles.bentoItem}`}>
              <div className={styles.bentoContent}>
                ...
                <p>فريق من الخبراء في مجالات متنوعة لمساعدتك في رحلة النجاح</p>
              </div>
            </div>
            ...
            <div className={`${UIStyles.glassCard} ${UIStyles.bentoItem}`}>
              <div className={styles.bentoContent}>
                ...
                <p>ورش عمل أسبوعية للتعلم وتطوير المهارات بأسلوب عملي وفعال</p>
              </div>
            </div>

            {/* Feature 4 - Wide Card */}
            <div
              className={`${UIStyles.glassCard} ${UIStyles.bentoItem} ${UIStyles.wide}`}
            >
              <div className={styles.bentoContent}>
                <div className={styles.bentoIcon}>
                  <Image
                ...
                <h3>تدريب متخصص</h3>
                <p>
                  برامج تدريبية مصممة خصيصاً لتطوير مهاراتك واحترافيتك في مجال
                  تخصصك
                </p>
              </div>
            </div>
            ...
            {/* Feature 5 - Tall Card */}
            <div
              className={`${UIStyles.glassCard} ${UIStyles.bentoItem} ${UIStyles.tall}`}
            >
              <div className={styles.bentoContent}>
                <div className={styles.bentoIcon}>
                  <Image
                ...
                <h3>مجتمع مدارات</h3>
                <p>
                  انضم إلى مجتمع من المبدعين والمفكرين لتبادل الخبرات والأفكار
                  والتعاون في مشاريع إبداعية
                </p>
