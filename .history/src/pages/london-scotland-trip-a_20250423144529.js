...
export default function LondonScotlandTripA() {
  // Renamed function
  ...
  return (
    <div className={styles.container} dir="rtl">
      <Head>
        <title>استكشف لندن واسكتلندا مع مدارات الكون | رحلة ساحرة - A</title>{' '}
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.title}>
              ...
              <span className={styles.highlight}>اسكتلندا</span> الساحرة (A){' '}
              {/* Added variant indicator */}
            </h1>
