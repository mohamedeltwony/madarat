...
import { Fireworks } from 'react-fireworks'; // Correct import
import styles from '@/styles/pages/ThankYou.module.scss'; // We'll create this next
import SparkleButton from '@/components/UI/SparkleButton'; // Re-use button style
...
export default function ThankYouResident() {
  ...
  return (
    <div className={styles.container} dir="rtl">
      ...
      {/* Fireworks Overlay */}
      <Fireworks {...fwProps} style={{ top: 0, left: 0, width: '100%', height: '100%', position: 'fixed', zIndex: 1 }} />
