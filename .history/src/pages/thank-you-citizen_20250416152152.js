...
export default function ThankYouCitizen() {
  ...
  // Fire Pixel Lead event on page load
  useEffect(() => {
    if (typeof window !== 'undefined' && window.fbq) {
      console.log('Firing Pixel Lead event on thank-you-citizen page load');
      window.fbq('track', 'Lead');
    } else {
      console.log('fbq not available on thank-you-citizen page load');
    }
