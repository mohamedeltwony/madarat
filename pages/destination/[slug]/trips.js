 ...
 * This component redirects /destination/[slug]/trips to /destination/[slug]
...
export default function DestinationTripsRedirect() {
  ...
  useEffect(() => {
    if (slug) {
      ...
      router.replace(`/destination/${slug}`, undefined, { shallow: false });
    }
  }, [slug, router]);
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`/destination/${slug}`} />
      </Head>
      <div style={{ 
        display: 'flex', 
