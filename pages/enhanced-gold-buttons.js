  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Demo page for enhanced gold buttons with true transparent backgrounds"
        />
      </Head>
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            ...
            <div
              ...
              style={{ background: 'linear-gradient(45deg, #8B4513, #CD853F)' }}
            >
              <EnhancedGoldButton
          ...
          <div className={styles.card}>
            ...
            <div
              ...
              style={{ background: 'linear-gradient(45deg, #8B4513, #CD853F)' }}
            >
              <EnhancedGoldButton text="Go to Home" href="/" />
            </div>
          </div>
