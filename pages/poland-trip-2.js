...
export default function PolandTrip() {
  ...
  // Features data - Updated for Poland with new inclusions
  const features = [
    {
  ...
  return (
    <div className={styles.container} dir="rtl">
      <Head>
        <title>رحلة بولندا 8 أيام مع مدارات الكون | 4990 ريال شامل الإقامة والجولات</title>
        <meta
          name="description"
          content="رحلة سياحية استثنائية إلى بولندا لمدة 8 أيام مع شركة مدارات الكون للسياحة والسفر. شامل الإقامة مع الإفطار، الجولات السياحية، والتنقلات. السعر 4990 ريال للشخص في الغرفة المزدوجة."
        />
        <meta
          name="viewport"
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.description}>
              {' '}
              {/* Updated description with new data */}
              بولندا 8 أيام
              <br />
              العرض يشمل جميع الخدمات المميزة
              <br />
              السعر للشخص في الغرفة المزدوجة{' '}
              <span className={styles.highlight}>4990</span> ريال
            </p>
